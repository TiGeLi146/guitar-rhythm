...
def run_level2():
    ...
    bg = pygame.transform.scale(load_image('level2_bg.jpg'), (WIDTH, HEIGHT))
    screen.blit(bg, (0, 0))

    NEWARROWEVENT = pygame.USEREVENT + 1
    pygame.time.set_timer(NEWARROWEVENT, 500)

    ENDLEVELEVENT = pygame.USEREVENT + 2
    pygame.time.set_timer(ENDLEVELEVENT, 116000, 1)

    CHANGERADEVENT = pygame.USEREVENT + 3
    pygame.time.set_timer(CHANGERADEVENT, 50)
